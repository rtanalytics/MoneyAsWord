...
public class GermanThousandToWordsMapper implements GenderAwareIntegerToWordsMapper {

    private final Map<Integer, GenderForms> baseValues;

    public GermanThousandToWordsMapper(Map<Integer, GenderForms> baseValues) {
