...
public class PortugueseThousandToWordsMapper implements NumberToWordsConverter<Integer> {
    ...
    public PortugueseThousandToWordsMapper(Map<Integer, GenderForms> baseValues,
